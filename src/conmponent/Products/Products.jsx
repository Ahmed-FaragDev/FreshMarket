        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 w-10/12 m-auto mt-5 mb-10  ">
          {products.map((product) => (
            ...
            >
              ...
              <button onClick={()=>addProductToCart(product.id)} className="bg-main cursor-pointer rounded-full  w-1/2 p-2 m-auto invisible group-hover:visible hover:bg-main/80 transition-all duration-300 ease-in mt-5 mb-1  bottom-0 left-1/4">
                Add to Cart
              </button>
            </motion.div>
          ))}
